...
public class AnuncioDAO {
  ...
  public static int save(int id,String titulo, String propietario, String destinatario, String cuerpo, String fase, String tag, String fcom, String ffin){
	int status=0;
	try{
		...
		PreparedStatement ps=con.prepareStatement(sql.Asave);
...
public static int update(String titulo, String propietario, String destinatario, String cuerpo, String fase, String tag, String fcom, String ffin, int id){
	int status=0;
	try{
		Connection con=getConnection();
		PreparedStatement ps=con.prepareStatement(sql.Aupdate);
...
public static Hashtable<String,String> queryById (int id) {
	...
	try {
	    ...
	    ResultSet rs = stmt.executeQuery(sql.Aselect);
	    while (rs.next()) {
...
public static int delete(int id){
	...
	try{
		Connection con=getConnection();
		PreparedStatement ps=con.prepareStatement(sql.Adelete);
		ps.setId(1,id);
		status=ps.executeUpdate();
	}catch(Exception e){System.out.println(e);}
